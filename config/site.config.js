...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'sophiaasophieee@gmail.com',
  ...
  title: "Sophia's download server",
  ...
  footer:
    '<p style="font-size: 20px;">Made with <img src="https://soaphia.xyz/matt.png" height="20px"> by Sophia.</p>',
  ...
  email: 'mailto:sophiaasophieee@gmail.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/sophiaasophieee',
    },
  ],
